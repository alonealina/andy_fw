...
<div class="contact_div">
    <form name="mail_form" action="{{ route('fw.mail_send') }}" method="post" enctype="multipart/form-data">
    @csrf
        ...
        <div class="send_button" style="margin-top:50px;">
            <a href="#" onclick="clickMailButton()">送信</a>
        </div>
    </form>
</div>
...
<div class="contact_div_sp">
    <form name="mail_form" action="{{ route('fw.mail_send') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="send_button" style="margin-top:20px;">
            <a href="#" onclick="clickMailButton()" style="margin:auto;">送信</a>
        </div>
    </form>
</div>
